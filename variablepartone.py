...
# 2x + 3y = 10 ........... x and y are variables, 2,3,10  are literals (value)
# I buy 10 apples each cost RM1.20
# what amount to be paid?
# 10*1.20 = 12.00
# quantity * price = total
# q * p = y ------- model

# we are creating a varible buy and assign the string  literal "television" to the variable "buy" 
buy = "Television"
print (buy)
buy = "Laptop"
print (buy)
...
print("Address in quantity:", id(quantity)) # definetely a different address
...
price = 1455.55
isAvailable = True
# to find the data type assigned to the variable we can use another built in funciton
# called type
